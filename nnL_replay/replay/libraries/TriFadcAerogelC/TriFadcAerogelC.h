#ifndef ROOT_TriFadcAerogelC
#define ROOT_TriFadcAerogelC

///////////////////////////////////////////////////////////////////////////////
//                                                                           //
// TriFadcAerogelC                                                              //
//                                                                           //
// Generic AerogelC detector.                                               //
//                                                                           //
///////////////////////////////////////////////////////////////////////////////
...
class TriFadcAerogelC : public THaPidDetector {

public:
  TriFadcAerogelC( const char* name, const char* description = "",
	      THaApparatus* a = NULL );
  TriFadcAerogelC(); // for ROOT I/O
  virtual ~TriFadcAerogelC();
...
protected:
  ...
  ClassDef(TriFadcAerogelC,0)    //Generic AerogelC class
};
